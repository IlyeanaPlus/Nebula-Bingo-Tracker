...
export default function ReferencePanel({
  ...
  return (
    <section className="mb-6 p-4 bg-white rounded-2xl shadow-sm border border-slate-200">
      ...
      <p className="text-sm text-slate-600 mb-3">Upload, use Google Drive (public), paste URL list, or import a cache JSON.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div className="mt-2 flex items-center gap-3 text-xs text-slate-600">
            ...
            <label className="inline-flex items-center gap-2">
              <input type="checkbox" checked={rememberKey} onChange={(e)=>setRememberKey(e.target.checked)} /> remember API key
            </label>
          </div>
        </div>
