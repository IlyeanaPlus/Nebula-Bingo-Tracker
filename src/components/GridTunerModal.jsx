...
/**
 * GridTunerModal
 * - Crop square: green only, 5×5 grid
 * - Fully movable as a unit
 * - Resizable from all 4 corners with 1:1 aspect
...
export default function GridTunerModal({ imageSrc, initialFractions, onConfirm, onCancel }) {
  ...
  function drawOverlay() {
    ...
    // Dim outside the crop for clarity
    ctx.save();
    ...
    <div className="modal-backdrop">
      <div className="modal-window" role="dialog" aria-modal>
        ...
        <div style={{ position: "relative", display: "grid", placeItems: "center" }}>
          ...
          <div ref={boxRef} onMouseDown={handleDragStart} style={{ position: "absolute" }}>
